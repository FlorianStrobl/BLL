let logIt = false; // log certain the steps of the interpreter
  ...
  function executeExpr(expr, lets, types) {
    ...
    if (logIt) {
      ...
      if (parseExpr.type === "match")
        message = "match: " + parseExpr.type;

      if (parseExpr.type === "typeInstantiation")
        message = "typeInstantiation: " + parseExpr.type;
...
function demo(code, input = 0, filename = "file", steps = "11111", logInterpreterSteps = false, timeIt = true) {
...
let main = func (n) => sum(5);
`, 3 /*input*\/, "file" /*filename*\/, "11111" /*steps*\/, true /*logger*\/, true /*timer*\/)
*/